...
/*global process*/
var DEV = typeof process==='undefined' || !Object({"NODE_ENV":undefined}) || undefined!=='production';
...
var _SlideGenerator = __webpack_require__(23);

var _SlideGenerator2 = _interopRequireDefault(_SlideGenerator);
...
var react_entry_point = document.getElementById('react-entry-point');
...
var Root = function (_Component) {
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      return _react2.default.createElement(_SlideGenerator2.default, null);
    }
  }]);
...
if (react_entry_point) {
  _reactDom2.default.render(_react2.default.createElement(Root, null), react_entry_point);
}
...
var SlideGenerator = function (_Component) {
  _inherits(SlideGenerator, _Component);

  function SlideGenerator(props) {
    _classCallCheck(this, SlideGenerator);

    var _this = _possibleConstructorReturn(this, (SlideGenerator.__proto__ || Object.getPrototypeOf(SlideGenerator)).call(this, props));

    _this.constructSlideImage = _this.constructSlideImage.bind(_this);
    _this.constructSlideText = _this.constructSlideText.bind(_this);
    _this.fetchSlides = _this.fetchSlides.bind(_this);
  ...
  _createClass(SlideGenerator, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var me = this;
      var slides = me.fetchSlides(),
    ...
    key: 'constructSlideImage',
    value: function constructSlideImage() {
      var images = [];

      return images;
    }
  }, {
    key: 'constructSlideText',
    value: function constructSlideText() {
      var texts = [];
...
var slides_image = document.querySelector('#slides-image');
...
var Image = function Image(_ref) {
  ...
  return _reactDom2.default.createPortal(template, slides_image);
};
...
var slides_text = document.querySelector('#slides-text');
...
var Text = function Text(_ref) {
  ...
  return _reactDom2.default.createPortal(template, slides_text);
};
...
exports.init = function () {
  var settings = document.querySelector('#admin-settings');
